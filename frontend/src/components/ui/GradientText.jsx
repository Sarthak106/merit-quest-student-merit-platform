/*
 * GradientText – adapted from reactbits.dev
 * Renders text with an animated gradient background.
 */
...
export default function GradientText({
  ...
  useAnimationFrame(time => {
    ...
    if (yoyo) {
      ...
      progress.set(ct < animationDuration
  ...
  return (
    <motion.span
      className={`inline-block ${showBorder ? 'py-1 px-3 rounded-full' : ''} ${className}`}
